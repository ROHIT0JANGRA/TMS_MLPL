...
function LoadStep3() {
    ...
    AjaxRequestWithPostAndJson(ThcUrl + '/GetThcDocketListForStockUpdate', JSON.stringify(requestData), function (result) {
        ...
        if (result.length > 0) {
            $.each(result, function (i, item) {
               ...
               // item.DocketNo = item.DocketNo + item.DocketSuffix;
                ...
                item.ArrivalPackages = "<input type='hidden' value='" + item.DocketId + "' name='ManifestList[" + i + "].DocketId' id='hdnDocketId" + i + "'/>" +
                    ...
                    "<input type='hidden' value='" + item.DocketNoBarcode + "' name='ManifestList[" + i + "].DocketNoBarcode' id='hdnDocketNoBarcode" + i + "'/>" +
                    "<input type='hidden' value='" + item.DocketNoBarcodeScan + "' name='ManifestList[" + i + "].DocketNoBarcodeScan' id='hdnDocketNoBarcodeScan" + i + "'/>" +
                    "<input type='hidden' value='" + item.DocketPackages + "' name='ManifestList[" + i + "].DocketPackages' id='hdnDocketPackages" + i + "'/>" +
            ...
            dtDocketDetails.find('th').eq(7).css('width', '40px');
            dtDocketDetails.find('th').eq(8).css('width', '40px');
    ...
    $('#dtDocketDetails td:nth-child(12),th:nth-child(12)').hide();
}
