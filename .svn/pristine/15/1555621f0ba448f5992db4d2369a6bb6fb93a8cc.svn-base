...
{
    public class CustomerContractServices : BaseModel
    {
        ...
        //[Display(Name = "Part Volumetric Weight Type")]
        //public string PartVolumetricWeightType { get; set; }
        ...
        public List<CustomerContractRiskMatrix> CarrierDetails { get; set; }

        public List<CustomerContractRiskMatrix> OwnerDetails { get; set; }

        [Display(Name = "Delivery Reattempt Amount")]
        [Required(ErrorMessage = "Delivery Reattempt Amount can not be blank")]
        public Decimal DeliveryReattemptAmount { get; set; }
