...
var ddlDocumentTypeId, drDocumentDate, ddlCustomerId, txtDocumentNo, txtManualDocumentNo, dtDocketDetails, dtThcDetails, trackingUrl, dvDocketDetails, dvThcDetails, dtDrsDetails, dvDrsDetails,
...
function GetDocumentList() {
    ...
    var requestData = { locationId: "1", fromDate: drDocumentDate.startDate, toDate: drDocumentDate.endDate, documentNo: txtDocumentNo.val(), manualDocumentNo: txtManualDocumentNo.val(), CustomerId: ddlCustomerId.val() };
    if (ddlDocumentTypeId.val() == "1") {
        AjaxRequestWithPostAndJson(trackingUrl + '/GetDocketCustomerList', JSON.stringify(requestData), function (result) {
