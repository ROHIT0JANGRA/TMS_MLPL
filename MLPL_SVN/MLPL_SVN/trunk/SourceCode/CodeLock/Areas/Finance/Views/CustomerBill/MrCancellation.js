...
function InitObjects() {
    ...
    InitWizard('dvWizard', [
     { StepName: 'Criteria', StepFunction: GetMrBillList },
     { StepName: 'Mr List', StepFunction: CheckStepValid }
    ], 'Mr Cancel');
}

function GetMrBillList() {

    var requestData = {
        mrNos: txtMrNo.val(), fromDate: drMrDate.startDate, toDate: drMrDate.endDate
    };
    AjaxRequestWithPostAndJson(baseUrl + '/GetMrBillListForCancellation', JSON.stringify(requestData), function (result) {
