...
{
	public class CustomerBill : BaseModel
	{
		public CustomerBill()
		{
			this.BillNo = "";
			this.Details = new List<CustomerBillDetail>();
            this.ErrorList = new List<CustomerBillDetail>();
            this.CustomerBillSupplementryDetail = new List<CodeLock.Models.CustomerBillSupplementryDetail>();
            this.GSTDetails = new List<CustomerBillDetail>();

        }
        public string GstType { get; set; }

        [Display(Name = "Is RCM")]
        public string GstIsRCM { get; set; }

        [Display(Name = "Is Sez")]
        public string GstIsSez { get; set; }

        public string CustomerStateCode { get; set; }
        public string CompanyStateCode { get; set; }

        public string CompanyName { get; set; }
        public string SubmissionBillingAddress { get; set; }
        public string BillDateEdit { get; set; }
        public string DueDateEdit { get; set; }
        public bool IsBillExists { get; set; }

        [Required(ErrorMessage = "Please enter Bill No")]
        [Display(Name = "Bill No")]
        public string BillNoSearch { get; set; }
		...
		public Decimal DocketCount { get; set; }
        ...
        public List<CustomerBillDetail> ErrorList { get; set; }
        ...
        public string AllowEInvoice { get; set; }

        public string CompanyPinCode { get; set; }

        public string CustomerPinCode { get; set; }

        public string CompanyPinCity { get; set; }
        public string CustomerPinCity { get; set; }
