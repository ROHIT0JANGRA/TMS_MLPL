...
{
  public class CustomerContractModewiseServices
  {  

        [Display(Name = "Minimum Charged Weight")]
        [Range(0.0, 9999999999.99, ErrorMessage = "Please enter a value between 0 to 9999999999")]
        public Decimal MinimumChargedWeightRate { get; set; }

        [Display(Name = "Charged Weight Rate Type")]
    ...
    [Display(Name = "Divider Cft Measurement")]
    public Decimal DividerCftMeasurement { get; set; }

    [Display(Name = "Divider Cft Measurement Type")]
    [Required(ErrorMessage = "Please select Divider Cft Measurement")]
    ...
    [Display(Name = "Minimum Charge Amount")]
    [Range(0.0, 9999999999.99, ErrorMessage = "Please enter a value between 0 to 9999999999")]
    public Decimal MinimumFuelSurchargeAmount { get; set; }

    [Display(Name = "Maximum Charge Amount")]
