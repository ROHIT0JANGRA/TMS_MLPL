...
{
    public class MilkRunLog : BaseModel
    {
        ...
        public MilkRunLog()
        {
            this.Details = new List<MilkRunBillingDetail>();
        }
        public List<MilkRunBillingDetail> Details { get; set; }
    }

    public class MilkRunBilling : BaseModel
    {

        public MilkRunBilling()
        {
            this.Details = new List<MilkRunBillingDetail>();
        }
        ...
        [Display(Name = "Select Customer Business Type")]
        [Required(ErrorMessage = "Select Customer Business Type")]
        public short CustomerBusinessType { get; set; }
        ...
        [Required(ErrorMessage = "Please Select SAC Code")]
        public short SacCodeId { get; set; }
        ...
        public string ManualBillNoForTripBill { get; set; }
        ...
        public bool IsExemptGst { get; set; }
