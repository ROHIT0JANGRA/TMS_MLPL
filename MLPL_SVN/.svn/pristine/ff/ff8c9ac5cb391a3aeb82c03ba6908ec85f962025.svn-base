...
//    **----------
    ...
    //        },
    //        "dom": '<"row" <"col-md-3"l><"col-sm-4"T><"col-md-4"f>><"row" <"col-md-12"<"td-content"rt>>><"row" <"col-md-6"i><"col-md-6"p>>',
    //        buttons: [
    ...
    bb_demos.html_forms = function () {
        bootbox.dialog({
            ...
            message: '<div class="row">  ' +
                ...
                '</div> ' +
                '<div class="form-group"> ' +
                '<label class="col-md-4 label" for="awesomeness">How awesome is this?</label> ' +
            ...
            select: function (start, end) {
                var calMbox = bootbox.dialog({
                    ...
                    message: '<div class="row">  ' +
                        ...
                        '<form class="form-horizontal"> ' +
                        '<div class="form-group"> ' +
                        '<label class="col-md-4 label" for="name">Event Title</label> ' +
                        '<div class="col-md-6"> ' +
                        ...
                        '</div> ' +
                        '<div class="form-group"> ' +
                        '<label class="col-md-4 label" for="name">Select Color</label> ' +
                        '<div class="col-md-6"> ' +
