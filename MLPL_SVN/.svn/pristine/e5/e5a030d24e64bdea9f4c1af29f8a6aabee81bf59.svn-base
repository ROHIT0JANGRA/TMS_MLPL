...
public static class IOHelper
{
  ...
  public static string GetFileName(string documentType, string documentNo, string fileName)
  {
    return documentType + "_" + documentNo.Replace("/", "_") + "." + new Regex("(?:.+)(.+)\\.(.+)").Match(fileName).Groups[2].Captures[0].ToString();
  }
  ...
  public static Bitmap GenerateThumb(Bitmap bmp, int width, int height)
  {
    ...
    try
    {
      ...
      graphics.DrawImage((Image) bmp, new Rectangle(0, 0, width2, height2), new Rectangle(0, 0, width1, height1), GraphicsUnit.Pixel);
      bmp.Dispose();
      graphics.Dispose();
    }
    catch
  ...
  {
    return IOHelper.GetMimeType(ext.ToLower());
  }
  ...
  public static string GetMimeType(string extension)
  {
    ...
    if (!extension.StartsWith("."))
      extension = "." + extension;
    string str;
    return IOHelper._mappings.TryGetValue(extension, out str) ? str : "application/octet-stream";
  }
}
