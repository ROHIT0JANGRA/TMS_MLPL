...
function AttachEvents() {
    ...
    txtDocketNo.blur(function () {
        IsDocumentNoDcrDumptcoDocketPincodeExist($(this), 1, loginLocationId, GetFieldCaptionByName(docketFieldList, 'DocketNo'), true, hdnFromLocationId, lblFromLocation)
    ...
    PincodeAutoComplete('txtPinCode', 'hdnPincodeId');
    txtPinCode.blur(function () { return IsPincodeExist(txtPinCode, hdnPincodeId, txtToLocation, hdnToLocationId ) });
...
function LoadStep3() {
    ...
    var requestData = {
        ...
        IsConsignorConsigneePartyMapping: rules.IsConsignorConsigneePartyMapping, IsConsignorFromMaster: rdConsignorFromMaster.IsChecked, IsConsigneeFromMaster: rdConsigneeFromMaster.IsChecked, IsWalkInConsignorSaveInSystem: isWalkInConsignorSaveInSystem, IsWalkInConsigneeSaveInSystem: isWalkInConsigneeSaveInSystem, EntryBy: loginUserId, CompanyId: loginCompanyId, PinCodeId: $('#hdnPincodeId').val()
    };
    isLoadStep3 = true;
    isSuccessfull = true;
    AjaxRequestWithPostAndJson(baseUrl + '/GetStep3DetailforPincode', JSON.stringify(requestData), function (responseData) {
...
function GetStep1DetailById() {
    ...
    AjaxRequestWithPostAndJson(baseUrl + '/GetStep1DetailById', JSON.stringify(requestData), function (result) {
        ...
        $('#hdnPincodeId').val(result.PincodeId);
...
function IsInvoiceNoAvailable(objInvoiceId, objInvoiceNo) {
    if (objInvoiceNo.val() != "") {
        var requestData = { docketId: hdnDocketId.val(), invoiceId: objInvoiceId.val() == '' ? 0 : objInvoiceId.val(), invoiceNo: objInvoiceNo.val() };
